            ...
            {searchData.map((product) => (
              <div key={product.id} className="col">
                <div className="card h-100 shadow-sm">
                  <img 
                    src={product.imageUrl || convertBase64ToDataURL(product.imageData)} 
                  ...
                  <div className="card-body d-flex flex-column">
                    ...
                    <h5 className="card-text text-primary mt-auto mb-3">{Number(product.price).toLocaleString('vi-VN')} VNĐ</h5>
