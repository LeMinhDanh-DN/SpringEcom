          ...
          <div className="d-flex align-items-center">
            ...
            {isAuthenticated ? (
              <div className="d-flex align-items-center me-3">
                <span className="text-muted me-2 small">Hi, {user?.name || user?.username}</span>
                <button className="btn btn-outline-danger btn-sm" type="button" onClick={handleLogout}>
                  Logout
                </button>
              </div>
            ) : (
              <a href="/login" className="btn btn-outline-primary btn-sm me-3" onClick={handleLinkClick}>
                Login
              </a>
            )}
